...
//============================================================================
      openModal: function () {         
        ...
        $(orig.element).css('height',$(window).height() + 'px');
        orig.vars.vertcalc = ((orig.vars.vert / 100) * $(window).height()) + ($(window).scrollTop());
        if(orig.vars.vertcalc < $(this.element).find('.modal').outerHeight() / 2){
          orig.vars.vertcalc = $(this.element).find('.modal').outerHeight() / 2;
        }
        $(this.element).find('.modal').stop().css('top',$(window).height() /2 + 'px');
